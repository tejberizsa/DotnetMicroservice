...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class EditCommentController : ControllerBase
    {
        ...
        public EditCommentController(ILogger<EditCommentController> logger, ICommandDispacher commandDispacher)
        {
            _logger = logger;
        ...
        public async Task<ActionResult> EditCommentAsync(Guid id, EditCommentCommand command)
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Error while processing request to edit comment of a post!";
