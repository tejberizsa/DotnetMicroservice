...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class LikePostController : ControllerBase
    {
        ...
        public LikePostController(ILogger<LikePostController> logger, ICommandDispacher commandDispacher)
        {
            _logger = logger;
        ...
        public async Task<ActionResult> LikePostAsync(Guid id)
        {
            try
            {
                await _commandDispacher.SendAsync(new LikePostCommand{Id = id});
