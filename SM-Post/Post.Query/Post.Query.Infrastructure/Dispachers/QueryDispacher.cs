...
namespace Post.Query.Infrastructure.Dispachers
{
    public class QueryDispacher : IQueryDispacher<PostEntity>
    {
        ...
        public void RegisterHandler<TQuery>(Func<TQuery, Task<List<PostEntity>>> handler) where TQuery : BaseQuery
        {
            ...
            {
                throw new IndexOutOfRangeException("Cannot register the same query handler twice!");
            }
